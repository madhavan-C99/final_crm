                ...
                >
                    ...
                    >
                        ...
                        onClick={() => {
                                ...
                                const storedReturnPath = localStorage.getItem("lead_return_path");
                                const lastPath = storedReturnPath
                                    ? (storedReturnPath.startsWith("/telecalling/")
                                        ? storedReturnPath
                                        : `/telecalling${storedReturnPath.startsWith('/') ? '' : '/'}${storedReturnPath}`)
