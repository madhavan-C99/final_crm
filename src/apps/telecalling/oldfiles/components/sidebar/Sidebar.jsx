                ...
                >
                    ...
                    {topMenus.map((item, index) => {
                        ...
                        const isActive =
                            ...
                            (item.path === "/telecalling/pipeline" &&
                                location.pathname.startsWith("/telecalling/lead-details"));
                        return (
                            <Box
                                key={index}
                                // onClick={() => {
                                ...
                                onClick={() => {
                                        if (item.path === "/telecalling/pipeline") {
                                            ...
                                            const storedPath =
                                                sessionStorage.getItem("last_pipeline_path");
                                            // 🛡️ stale/old (pre-migration) path irundha ignore panni default ku pogum
                                            const lastPath =
                                                storedPath && storedPath.startsWith("/telecalling/")
                                                    ? storedPath
