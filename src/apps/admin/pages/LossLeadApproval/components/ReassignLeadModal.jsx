...
const ReassignLeadModal = ({
  ...
  return (
    ...
    >
      ...
      <Box sx={{ width: "100%", boxSizing: "border-box", p: 2, px: 2.5, display: "flex", flexDirection: "column", gap: 1, backgroundColor: "#FFFFFF" }}>
        {/* Lead Name */}
        ...
        <Divider sx={{ my: 0.3, borderColor: "#E5E7EB" }} />
      ...
      <Box sx={{ width: "100%", boxSizing: "border-box", backgroundColor: "#F9FAFB", p: 2, px: 2.5, pb: 2.5, borderTop: "1px solid #E5E7EB" }}>
        <Typography sx={{ fontSize: "13px", fontWeight: 700, color: "#000000", mb: 0.8 }}>
          Reassign to
        </Typography>
        ...
        {/* Telecallers List (Fixed 185px height so buttons always have clear space) */}
        <Box
          sx={{
            display: "flex",
